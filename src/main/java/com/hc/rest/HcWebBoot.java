...
@EnableSwagger2
@ComponentScan(basePackages = {"com.hc","com.hrt"}, basePackageClasses = { GreetingController.class, AccountResource.class,  })
public class HcWebBoot {
...
// 
    ...
    public static void main(String[] args) {
        SpringApplication.run(HcWebBoot.class, args);
    }
